...
@section('content')
    <div class="container grid px-6 mx-auto">
        ...
        <div class="flex justify-between">
            ...
            <x-button-redirect text="Create New" route="admin.product.create"></x-button-redirect>
        </div>
                ...
                <table class="w-full whitespace-no-wrap mb-5">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex space-x-2">
                                    <a href="{{  route('admin.product.edit',$product->id)  }}" class="flex items-center
                                ...
                                focus:shadow-outline-purple"
                                    ...
                                    <a href="{{  route('admin.product.destroy',$product->id)  }}" class="flex
                                items-center
                    ...
                    @empty
                        <tr class="text-gray-700">
                            <td colspan="5" class="text-center px-4 py-4">Empty Data</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
