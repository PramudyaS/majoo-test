...
<body>
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white min-h-screen">
    <header>
                ...
                <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                    ...
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        <div class="flex items-end justify-end h-56 w-full bg-cover"
                             style="background-image: url('{{  asset($product->image->url)  }}')">
                        ...
                        <div class="px-5 py-3">
                            ...
                            <span class="text-gray-500 mt-2">Rp.{{  number_format($product->price)  }}</span>
                        </div>
                    </div>
                    @empty
                        <p class="w-full col-span-full mx-auto font-semibold text-center">No Product Found</p>
                    @endforelse
                </div>
            </div>
        </div>
    ...
    <footer class="bg-gray-200">
        <div class="container mx-auto px-6 py-3 items-center">
            <p class="py-2 text-gray-500 sm:py-0 text-center">2021 &copy; All rights reserved</p>
        </div>
    </footer>
</div>
</body>
